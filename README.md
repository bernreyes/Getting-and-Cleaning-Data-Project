...
###README.md 
-It includes the basic information about the scripts used in this project and how they are connected.

###CodeBook.md 
-It consists of the information about the data, variables, and data transformations. Specific details about the data cleaning and creating tidy data are explained in this script.

###run_analysis.R
-It includes the R codes on how to download and unzip the datasets, merge the training and test datasets, properly label the data measurements, extracting only the variables about means and standard deviations, and write the tidy data into text file.
...
-It is not located in the Github repo since it is uploaded in coursera as part of the submission process.
